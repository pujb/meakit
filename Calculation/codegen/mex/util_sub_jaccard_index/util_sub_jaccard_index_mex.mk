...
MAKEFILE = util_sub_jaccard_index_mex.mk

include util_sub_jaccard_index_mex.mki


SRC_FILES =  \
	util_sub_jaccard_index_initialize.c \
	util_sub_jaccard_index_terminate.c \
	util_sub_jaccard_index.c \
	util_sub_jaccard_index_api.c \
	util_sub_jaccard_index_mex.c

MEX_FILE_NAME_WO_EXT = util_sub_jaccard_index_mex
...
SYS_INCLUDE += -I"D:\SOFTWA~1\matlab\util\CALCUL~1\codegen\mex\UTIL_S~2"
...
%.$(OBJEXT) : D:\SOFTWA~1\matlab\util\CALCUL~1\codegen\mex\UTIL_S~2/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
