...
MAKEFILE = util_sub_normalized_dot_product_mex.mk

include util_sub_normalized_dot_product_mex.mki


SRC_FILES =  \
	util_sub_normalized_dot_product_data.c \
	util_sub_normalized_dot_product_initialize.c \
...
MEX_FILE_NAME_WO_EXT = util_sub_normalized_dot_product_mex
...
SYS_INCLUDE += -I"D:\SOFTWA~1\matlab\util\CALCUL~1\codegen\mex\UTIL_S~1"
...
%.$(OBJEXT) : D:\SOFTWA~1\matlab\util\CALCUL~1\codegen\mex\UTIL_S~1/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
