...
panelroot.rootpanelid = 1;			% initially is 1, but if root panel gets recreated it will be different
...
P.panel.hiddenaxis = 0;		% used to display parent panel xlabel/ylabel, if present

% temp data store during export
P.panel.export = [];
