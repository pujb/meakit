...
mex -c flops.c -largeArrayDims
mex sameobject.c -largeArrayDims
mex int_hist.c -largeArrayDims
mex -c mexutil.c -largeArrayDims
mex -c util.c -largeArrayDims
...
if ispc
  ...
  mex addflops.c flops.obj -largeArrayDims
  ...
  if strncmp(compiler,'MSVC',4)
    ...
    mex randomseed.c util.obj random.lib -largeArrayDims
    mex randbinom.c mexutil.obj util.obj random.lib -largeArrayDims
    mex randgamma.c mexutil.obj util.obj random.lib -largeArrayDims
    mex sample_hist.c util.obj random.lib -largeArrayDims
  else
    fprintf('mexcompiler is not MSVC. The randomseed() function will have no effect.');
    mex randomseed.c util.obj random.c -largeArrayDims
    mex randbinom.c mexutil.obj util.obj random.c -largeArrayDims
    mex randgamma.c mexutil.obj util.obj random.c -largeArrayDims
    mex sample_hist.c util.obj random.c -largeArrayDims
  end
  mex repmat.c mexutil.obj -largeArrayDims
  try
    % standalone programs
  ...
  % UNIX
  mex addflops.c flops.o -largeArrayDims
  ...
  if ismac
    ...
    mex randomseed.c util.o librandom.dylib -lm -largeArrayDims
    mex randbinom.c mexutil.o util.o librandom.dylib -lm -largeArrayDims
    mex randgamma.c mexutil.o util.o librandom.dylib -lm -largeArrayDims
    mex sample_hist.c util.o librandom.dylib -lm -largeArrayDims
  else
    ...
    mex randomseed.c util.o librandom.so -lm -largeArrayDims
    mex randbinom.c mexutil.o util.o librandom.so -lm -largeArrayDims
    mex randgamma.c mexutil.o util.o librandom.so -lm -largeArrayDims
    mex sample_hist.c util.o librandom.so -lm -largeArrayDims
  end
  mex repmat.c mexutil.o -largeArrayDims
  try
    % standalone programs
    if atleast78
			disp('lightspeed''s matfile utility is not supported for this version of Matlab');
