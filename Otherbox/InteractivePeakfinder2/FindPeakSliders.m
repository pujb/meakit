...
% Tom O'Haver (toh@umd.edu). Version 1.7 July 30, 2008
...
SlopeMin=10^-6;
AmpMax=max(y);
if min(y)<0, AmpMin=min(y); else AmpMin=0; end
SmoothWidthMax=100;
FitWidthMax=100;
...
rtslid(h,@BGSlider,h2,0,'Scale',[0 1],'Def',0,'Back',[0.9 0.9 0.9],'Label','BG','Position',[0.94 0.8 0.03 0.04]);
rtslid(h,@SmoothSlider,h2,0,'Scale',[0 2],'Def',log10(SmoothWidth),'Back',[0.9 0.9 0.9],'Label','Smooth','Position',[0.94 0.42 0.03 0.3]);
rtslid(h,@FitSlider,h2,0,'Scale',[log10(3) log10(FitWidthMax)],'Def',log10(FitWidth),'Back',[0.9 0.9 0.9],'Label','Fit','Position',[0.95 0.04 0.03 0.3]);
