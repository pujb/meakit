...
% type warning off MATLAB:polyfit:RepeatedPointsOrRescale
...
rtslid(h,@SlopeTSlider,h2,1,'Scale',[log10(SlopeMin) log10(SlopeMax)],'Def',log10(SlopeThreshold),'Back',[0.9 0.9 0.9],'Label','SlopeT','Position',[0.03 0.5 0.03 0.35]);
rtslid(h,@AmpTSlider,h2,0,'Scale',[AmpMin AmpMax],'Def',AmpThreshold,'Back',[0.9 0.9 0.9],'Label','AmpT','Position',[0.03 0.04 0.03 0.35]);
rtslid(h,@BGSlider,h2,0,'Scale',[0 1],'Def',0,'Back',[0.9 0.9 0.9],'Label','BG','Position',[0.94 0.9 0.03 0.04]);
rtslid(h,@SmoothSlider,h2,0,'Scale',[0 2],'Def',log10(SmoothWidth),'Back',[0.9 0.9 0.9],'Label','Smooth','Position',[0.94 0.32 0.03 0.2]);
rtslid(h,@FitSlider,h2,0,'Scale',[log10(3) log10(FitWidthMax)],'Def',log10(FitWidth),'Back',[0.9 0.9 0.9],'Label','Fit','Position',[0.94 0.04 0.03 0.2]);
rtslid(h,@PeakSlider,h2,0,'Scale',[0 MaxPeaks],'Def',0,'Back',[0.9 0.9 0.9],'Label','Peak','Position',[0.94 0.6 0.03 0.22]);
