...
elseif isempty(max([nsFile.Segment.DataentityIDs,nsFile.Event.EntityID,nsFile.Analog.DataentityIDs,...
        nsFile.Neural.EntityID,[nsFile.EntityInfo.EntityID]]))
    newdata.Event.EntityID=1;
else
