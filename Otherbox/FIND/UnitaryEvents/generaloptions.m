...
% Last Modified by GUIDE v2.0 15-Sep-2002 15:11:35
...
if isequal(varargin{1},'init')  % LAUNCH GUI
    ...
    switch handles.cancel
      case 'off'
        ...
        information('Saved changes made in General Options menu.');
        drawnow;
      case 'on'
        DataFile = handles.originaldata;
        
        information('No changes applied in General Options menu.');
        drawnow;
    end
