...
% Last Modified by GUIDE v2.0 19-Aug-2002 15:26:55
...
if isequal(varargin{1},'init') % LAUNCH GUI
    ...
    information(['You can enter new marker types, colors in RGB format and height of the ' ...
                 ...
                 'The height parameters are relative to the plot size. ']); 
    drawnow;
    ...
    switch handles.cancel
     case 'off'
        ...
        information('Saved changes made in Dot Display Parameters menu.');
        drawnow;
     case 'on'
        DataFile = handles.originaldata;
        
        information('No changes applied in Dot Display Parameters menu.');
        drawnow;
    end
