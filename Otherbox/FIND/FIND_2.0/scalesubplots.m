...
%function coords=scalesubplots(nrow,ncol)
%creates a nrow by ncol array of coordinates for subplots, so that no space
%between subplots is lost
%coordinates are to be stored in the 'Position'
%property of the respective subplots.
