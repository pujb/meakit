...
try
  ...
  % post cutout time
    ...
    radioGroup = uibuttongroup('visible','off'...
        ,'Units','characters',...
        'Position',[1 3.75 GUIwidth/2-3 (GUIheight)*.5-1.75],...
    ...
    uicontrol('Parent',radioGroup,...
        'Units','characters',...
        'Position',[4   3.5  20    BUTTON_HEIGHT-0.25],...
        'Style','edit',...
        'String','[20]',...
        'Tag','detectSpikesGUI_median',...
        'Enable','on');
    
     radioButton5 = uicontrol('Style','Radio',...
        'String','5) CoB',...
        'Units','characters',...
        'pos',[.5 2 23 BUTTON_HEIGHT],...
        'parent',radioGroup,...
        'HandleVisibility','off',...
        'Enable','off',...
        'Tag','detectSpikesGUI_radioButton5');
    
    %which polarity
    polarityGroup = uibuttongroup('visible','off',...
         'Units','characters',...
        'Position',[1 1 GUIwidth/2-3 BUTTON_HEIGHT*1.25],...
        'Parent',upperRightPanel,...
        'Tag','detectSpikesGUI_polarityGroup');
    
    uicontrol('Parent',polarityGroup,...
        'Units','characters',...
        'Position',[0  1   14    BUTTON_HEIGHT],...
        'Style','Text',...
        'String','detection on :',...
        'HandleVisibility','off',...
    ...
    set(polarityGroup,'SelectedObject',[absButton]);  % Select one Default
    set(polarityGroup,'UserData','both'); % also set the userdata default
