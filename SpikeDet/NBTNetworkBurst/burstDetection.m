function [burstTrain, burstEventTrain] = burstDetection(peakTrain, ...
...
% ARGUMENTS:
% %%
% peakTrain:    sparse array ([number of samples x 1]), containing 1
